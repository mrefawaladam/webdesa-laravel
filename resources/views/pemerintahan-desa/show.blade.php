...
<meta name="description"
    content="{{ $pemerintahan_desa->judul }} Pemerintahan Desa {{ $desa->nama_desa }}, Kecamatan {{ $desa->nama_kecamatan }}, Kabupaten {{ $desa->nama_kabupaten }}.">
    ...
    <div class="row mb-5">
        <div class="col-md text-center">
            <img class="mw-100" src="{{ url(Storage::url($pemerintahan_desa->gambar)) }}"
                alt="Gambar Informasi Pemerintahan Desa {{ $pemerintahan_desa->judul }}">
        </div>
    </div>
    @endif
    <div class="card">
