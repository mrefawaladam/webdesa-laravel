...
@section('header')
<h1 class="text-white text-sm text-muted">SELAMAT DATANG DI WEBSITE RESMI CICD</h1>
    ...
    <div class="row mt-4 justify-content-center">
        ...
        <div class="col-lg-4 col-md-6 surats">
            <div class="single-service bg-white rounded shadow p-3 animate-up">
                <a href="{{ url('buat-surat', ['id' => $item->id,'slug' => Str::slug($item->nama)]) }}">
        ...
        <a href="{{ url('layanan-surat') }}" class="btn btn-primary">Lebih Banyak Surat</a>
        @endif
    </div>
</section>
@endif
...
<section class="mb-5">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="card animate-up shadow">
                <a href="{{ url('berita.show', ['berita' => $item, 'slug' => Str::slug($item->judul)]) }}">
                    <div class="card-img"
    ...
    <div class="text-center">
        <a href="{{ url('berita') }}" class="btn btn-primary">Lebih Banyak Berita</a>
    </div>
    @endif
</section>
@endif
...
<section class="mb-5">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="card animate-up shadow">
                <a
                    href="{{ url('pemerintahan-desa.show', ['pemerintahan_desa' => $item, 'slug' => Str::slug($item->judul)]) }}">
                    <div class="card-img"
                        style="background-image: url('{{ $item->gambar ? url(Storage::url($item->gambar)) : url(Storage::url('noimage.jpg')) }}'); background-size: cover; height: 200px;">
                    </div>
                </a>
    ...
    <div class="text-center">
        <a href="{{ url('pemerintahan-desa') }}" class="btn btn-primary">Lebih Banyak Informasi Pemerintahan Desa</a>
    </div>
    @endif
</section>
@endif
...
<section class="mb-5">
    ...
    <div class="text-center">
        <a href="{{ url('gallery') }}" class="btn btn-primary">Lebih Banyak Gallery</a>
    </div>
    @endif
</section>
@endif
<iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15812.569459422097!2d110.8873002276757!3d-7.774724960348977!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a30041c45a6b1%3A0x5027a76e356a380!2sGemantar%2C%20Kec.%20Selogiri%2C%20Kabupaten%20Wonogiri%2C%20Jawa%20Tengah!5e0!3m2!1sid!2sid!4v1669042044622!5m2!1sid!2sid"
