...
<p class="text-white">Grafik Anggaran Pendapatan Belanja Desa {{ $desa->nama_desa }}, masyarakat dapat dengan mudah
    mengetahui informasi mengenai Grafik Anggaran Pendapatan Belanja Desa {{ $desa->nama_desa }}.</p>
@endsection
