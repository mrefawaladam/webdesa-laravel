                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div
                            ...
                            <div class="mb-3">
                                <a href="{{ route("surat.show",$cetakSurat->surat) }}" class="btn btn-success"
    ...
    <div class="card-body px-lg-5 py-lg-5">
        <form role="form" action="{{ route('cetakSurat.update', $cetakSurat) }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input id="nomor" class="form-control form-control-alternative" name="nomor" autofocus
                    placeholder="Masukkan Nomor" value="{{ $cetakSurat->nomor }}">
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input required id="{{ $isiSurat->isi .''.$key }}" class="form-control form-control-alternative"
            ...
            <div class="form-group mb-3">
                ...
                <input required id="{{ $hasil .''.$k }}" class="form-control form-control-alternative" name="isian[]"
...
<script>
    $(document).ready(function () {
        let detailCetak = {
            !!json_encode($cetakSurat - > detailCetak) !!
        };
