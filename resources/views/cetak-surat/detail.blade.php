...
<body>
    <div style="margin:1cm">
        ...
        <div style="width: 50%" class="float-left">
            ...
            <table>
                <tbody>
                    <tr>
                        <td>Nomor</td>
                        <td>:{!! $cetakSurat->nomor ? ' 140 / ' . $cetakSurat->nomor . ' / 20.2003 /' .
                            Terbilang::roman(date('m', strtotime($cetakSurat->created_at))) . " / " . date('Y',
                            strtotime($cetakSurat->created_at)) : " 140 / " . str_repeat('&nbsp;', 10) . " / 20.2003 / "
                            . Terbilang::roman(date('m', strtotime($cetakSurat->created_at))) . " / " . date('Y',
                            strtotime($cetakSurat->created_at)) !!}</td>
                    </tr>
                    <tr>
                        <td>Sifat</td>
                        <td>: {{ $perihal[0] }}</td>
        ...
        <div class="text-center mt-5 mb-3">
            ...
            Nomor : {!! $cetakSurat->nomor ? ' 140 / ' . $cetakSurat->nomor . ' / 20.2003 /' .
            Terbilang::roman(date('m', strtotime($cetakSurat->created_at))) . " / " . date('Y',
            strtotime($cetakSurat->created_at)) : " 140 / " . str_repeat('&nbsp;', 10) . " / 20.2003 / " .
            Terbilang::roman(date('m', strtotime($cetakSurat->created_at))) . " / " . date('Y',
            strtotime($cetakSurat->created_at)) !!}
        </div>
        @endif
