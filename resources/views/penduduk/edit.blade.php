                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('kewarganegaraan') is-invalid @enderror"
                                ...
                                <option value="1"
                                    {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 1 ? 'selected' : ''  }}>WNI
                                </option>
                                <option value="2"
                                    {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 2 ? 'selected' : ''  }}>WNA
                                </option>
                                <option value="3"
                                    {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 3 ? 'selected' : ''  }}>Dua
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('dusun') is-invalid @enderror" name="dusun" id="dusun">
                                ...
                                <option value="{{ $item->id }}"
                                    {{ old('dusun', $penduduk->detailDusun ? $penduduk->detailDusun->dusun_id : "") == $item->id ? 'selected' : ''  }}>
                                    {{ $item->nama }}</option>
                                @endforeach
                            </select>
                            @error('dusun')<span
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('detail_dusun_id') is-invalid @enderror"
                                name="detail_dusun_id" id="detail_dusun_id"></select>
                            @error('detail_dusun_id')<span
                                class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                        </div>
                    </div>
