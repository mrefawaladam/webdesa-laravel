                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('darah_id') is-invalid @enderror" name="darah_id"
                                ...
                                <option value="{{ $item->id }}"
                                    {{ old('darah_id') == $item->id ? 'selected="true"' : ''  }}>{{ $item->golongan }}
                                </option>
                                @endforeach
                            </select>
                            @error('darah_id')<span
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('agama_id') is-invalid @enderror" name="agama_id"
                                ...
                                <option value="{{ $item->id }}"
                                    {{ old('agama_id') == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}
                                </option>
                                @endforeach
                            </select>
                            @error('agama_id')<span
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('pendidikan_id') is-invalid @enderror"
                                ...
                                <option value="{{ $item->id }}"
                                    {{ old('pendidikan_id') == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select style="width: 100%;"
                                ...
                                <option value="{{ $item->id }}"
                                    {{ old('pekerjaan_id') == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('dusun') is-invalid @enderror" name="dusun" id="dusun">
                                ...
                                <option value="{{ $item->id }}"
                                    {{ old('dusun') == $item->id ? 'selected="true"' : ''  }}>{{ $item->nama }}</option>
                                @endforeach
                            </select>
                            @error('dusun')<span
                                class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
